...
**51 tools**, each a signed, test-gated `.deb` rebuilt automatically on every upstream release — `uv`, `vite-plus`, `eza`, `lazygit`, `ruff`, `bun`, `deno`, `duckdb`, `lazydocker`, `ripgrep`, `fd`, `fzf`, and 39 more.
